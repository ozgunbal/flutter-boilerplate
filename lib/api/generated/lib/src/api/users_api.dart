...
class UsersApi {
  ...
  Future<Response<User>> createUser({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(createUserRequest, specifiedType: _type);
  ...
  Future<Response<void>> deleteUser({ 
    ...
    final _path = r'/users/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
